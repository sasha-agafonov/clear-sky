...
void shape::icosahedron(struct material* bad_material)
{
...
double shape::vectorLength(double a, double b, double c)
{
    return (sqrt(pow(a, 2) + pow(b, 2) + pow(c, 2)));
}


void shape::cube(struct material* bad_material)
{
...
void shape::triangularPrism(struct material* bad_material)
{
...
void shape::hollowCylinder(struct material* bad_material, int segments, int rings, double innerRad)
{
